...
namespace Zed.Web.Routes {
    ...
    public static class RouteHelper {
        ...
        public static bool RouteDataMatchWith(RouteData routeData, string expectedActionName, string expectedControllerName, object expectedRouteValues = null) {
            ...
            bool result = stringCompare(routeData.Values[ROUTE_VALUE_KEY_CONTROLLER], expectedControllerName)
                          && stringCompare(routeData.Values[ROUTE_VALUE_KEY_ACTION], expectedActionName);
        ...
        /// <param name="expectedControllerName">Expected controller name.</param>
        /// <param name="expectedRouteValues">Expected other segment variable values.</param>
        public static bool MatchWith(this RouteData routeData, string expectedActionName, string expectedControllerName, object expectedRouteValues = null) {
